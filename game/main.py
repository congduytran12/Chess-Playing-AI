...
async def main():
    ...
    while running:
        ...
        center_x = modeBtnRect.right - 20
        center_y = modeBtnRect.centery
        if mode_dropdown_open:
            p.draw.polygon(screen, p.Color('white'), [(center_x - 6, center_y + 4), (center_x + 6, center_y + 4), (center_x, center_y - 4)])
        else:
            p.draw.polygon(screen, p.Color('white'), [(center_x - 6, center_y - 4), (center_x + 6, center_y - 4), (center_x, center_y + 4)])
        ...
        if multiplayerMode:
            ...
            center_x = dropdownMainRect.right - 20
            center_y = dropdownMainRect.centery
            if dropdown_open:
                p.draw.polygon(screen, p.Color('white'), [(center_x - 6, center_y + 4), (center_x + 6, center_y + 4), (center_x, center_y - 4)])
            else:
                p.draw.polygon(screen, p.Color('white'), [(center_x - 6, center_y - 4), (center_x + 6, center_y - 4), (center_x, center_y + 4)])
